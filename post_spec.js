...
describe('expect(\'json\')', function() {
  ...
  it('should match array using json', function(doneFn) {
    post.fromJSON(['a', 1, true, null])
      .expect('json', ['a', 1, true, null])
      .then(function() {
        return post.fromJSON(['a', 1, true, null])
      ...
      .then(function() {
        return post.fromJSON([{a: 0}, {b: 1}, {c: 2}, [0, 1, 2]])
